...
## Etat de realisation - 2026-09-04

- wheel `0.4.0` deploye;
- Job News actif avec budget par defaut 10;
- table `workspace.vigie.news_ai_run_audit` creee;
- acceptation budget zero reussie sur le run `433107641891201`;
- 0 appel modele, 43 succes conserves et 2 lignes differees;
- Bronze, Silver, enrichissement et Gold reconcilies a 45 lignes;
- App deployee et RUNNING avec panneau sante;
